...
function Dashboard() {
    ...
    return (
        <div className="container mx-auto px-6 py-8">
            <h3 className="text-gray-700 dark:text-white text-3xl font-medium">Dashboard</h3>
                    ...
                    <div className="bg-white dark:bg-dark-secondary rounded-lg shadow-sm p-6">
                        <div className="flex items-center">
                            ...
                            <div className="mx-5">
                                ...
                                <div className="text-gray-500 dark:text-gray-400">Kurum Sayısı</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-dark-secondary rounded-lg shadow-sm p-6">
                        <div className="flex items-center">
                            ...
                            <div className="mx-5">
                                ...
                                <div className="text-gray-500 dark:text-gray-400">Ülke Sayısı</div>
                            </div>
                        </div>
                    </div>
                </div>
